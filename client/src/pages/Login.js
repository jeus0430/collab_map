...
class Login extends Component {
    ...
    handleLogin = (e) => {
        ...
        if ( !userCredentialsValid ) {
            ...
            userLoginRequest(this.state.userCredentials)
            .then(res => {
    ...
    render() {
        ...
        return (
            <div className="container">
                <br />
                <div className="pan">
                    <div style={{fontSize: 20, textAlign: "center", fontWeight: "bold"}}>Login</div>
                    ...
                    <div style={{fontSize: 12, color: "grey", textAlign: "center"}}>Do you have't got account?   
                      <Link
                        to={{
                          pathname: "/signup",
                          // state: {
